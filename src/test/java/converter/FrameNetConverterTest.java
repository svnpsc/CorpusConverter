...
public class FrameNetConverterTest {
	...
	private static final String SAMPLE_CORPUS_PATH = "data/FrameNet/NTICorpus.xml";
	private static final String SAMPLE_CORPUS_TWO_PATH = "data/FrameNet/SmallTest.xml";
	...
	public void convertToTigerXml() throws IOException, JAXBException {
		...
		tigerxml.TigerXmlMapper.save(target, "data/FrameNet/SmallTestAsTigerXML.xml");
