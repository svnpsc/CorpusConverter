...
public class TigerXmlConverterTest {
	...
	private static final String SAMPLE_TIGER_XML_CORPUS_PATH = "data/TigerXML/Testcorpus.xml";
	...
	public void convertToFrameNet() {
		...
		try {
			framenet.FrameNetMapper.save(target, "data/TigerXML/TestcorpusAsFrameNet.xml");
		} catch (IOException e) {
	...
	public void convertToConll() {
		...
		try {
			conll.ConllMapper.save(target, "data/CoNLL/TestcorpusFromTigerXml.xml");
		} catch (IOException e) {
			fail("Saving failed. IOException was thrown: " + e.getMessage());
		}		
	}
